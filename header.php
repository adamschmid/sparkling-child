...
<div id="page" class="hfeed site">
	<header id="masthead" class="site-header" role="banner">
		<nav class="navbar navbar-default" role="navigation">
			<div class="container">
				...
				<div class="site-navigation-inner col-sm-12">
					<div class="shipping-note-lg">
						<p class="shipping-title blink">Free Shipping!</p>
						<p class="shipping-text">*on <a class="most">most</a> orders over $49</p>
					</div>
		...
		<div id="sub-header">
			...
			<ul>
				<li id="sub-nav-logo">
					<a href="http://foxtonemusic.com">Foxtone Music Home</a>
				</li>
			</ul>
			<div class="primary_head_menu">
