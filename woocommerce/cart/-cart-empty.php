...
<p class="return-to-shop"><a class="button wc-backward" href="<?php echo apply_filters( 'woocommerce_return_to_shop_redirect', home_url() ); ?>"><?php _e( 'Return To Home Page', 'woocommerce' ) ?></a></p>